...
//!
//! ```ignore
//! use qsh_client::control::protocol::{encode_message, decode_message, MessageKind};
//!
//! // Create a command
...
//!     kind: Some(proto::message::Kind::Command(cmd)),
//! };
//!
...
use super::proto;
use super::resource::{
    FailureReason, FileTransferDetails, ForwardDetails, ForwardType, ResourceDetails,
