{
  ...
  outputs = { self, nixpkgs, fenix, flake-utils, android-nixpkgs }:
    flake-utils.lib.eachDefaultSystem (system:
      let
        ...
        targetStds = builtins.map (target:
          pkgs.fenix.targets.${target}.stable.rust-std
        ) crossTargets;
        ...
        linuxCrossInputs = with pkgs; pkgs.lib.optionals isLinux [
